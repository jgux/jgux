...
<head>
    ...
    <link rel="stylesheet" href="/regist/style/goods.css" type="text/css">
    <link rel="stylesheet" href="/regist/style/common.css" type="text/css">
    ...
    <!--引入jqzoom css -->
    <link rel="stylesheet" href="/regist/style/jqzoom.css" type="text/css">
    ...
    <script type="text/javascript" src="/regist/js/goods.js"></script>
    <script type="text/javascript" src="/regist/js/jqzoom-core.js"></script>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="<?=\yii\helpers\Url::to(['index/index'])?>">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> ><?php
            $id=$_GET["id"];
        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="/regist/images/relate_view1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/regist/images/relate_view2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/regist/images/relate_view3.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/regist/images/relate_view4.jpg" alt="" /></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src="/regist/images/relate_view5.jpg" alt="" /></a></dt>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="/regist/images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        ...
                        <?php
                        //获取所有的图片
                        $imgs=\backend\models\GoodsGallery::find()->where(['goods_id'=>$id])->all();
                        foreach ($imgs as $img):
                        ?>
                            <li class="cur">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <img src="/regist/images/desc1.jpg" alt="" />
                        <?php
                        $goodsIntro=\backend\models\GoodsIntro::find()->where(["goods_id"=>$id])->one();
                        echo $goodsIntro->content;
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/regist/images/user1.gif" alt="" /></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/regist/images/user2.jpg" alt="" /></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/regist/images/user3.jpg" alt="" /></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
